...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2025 at 05:21 PM
...
(71, 20, '2025-01-03', 'fridge', 19000.00, 3, '2025-01-03 16:13:27');
...
--
-- Dumping data for table `tbl_auto_expenses`
--

INSERT INTO `tbl_auto_expenses` (`ID`, `UserId`, `ExpenseItem`, `ExpenseCost`, `CategoryID`, `NextDueDate`, `Frequency`, `IsActive`, `CreatedAt`, `UpdatedAt`) VALUES
(1, 21, 'sgfghf', 500.00, 6, '0000-00-00', '', 1, '2024-10-06 06:33:52', '2024-10-06 06:33:52');
